...
class ServerPathDefinitions
{
    ...
    {
        return (isset($_SERVER['SERVER_PORT']) AND in_array($_SERVER['SERVER_PORT'],
            array(
              80,
              443
            )))
    ...
    {
        return $this->getRelativePath($this->server_document_root,
          $this->install_dir);
    }

    public function getWordpressCodebaseRelativePath()
    {
        return $this->getRelativePath($this->install_dir,
